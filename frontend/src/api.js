...
export const api = {
  ...
  setEmbyCredentials: (payload) => request('settings/emby-credentials', { method: 'POST', body: JSON.stringify(payload) }),
  clearEmbyCredentials: () => request('settings/emby-credentials', { method: 'POST', body: JSON.stringify({ clear: true }) }),
  setTmdbCredentials: (payload) => request('settings/tmdb-credentials', { method: 'POST', body: JSON.stringify(payload) }),
  clearTmdbCredentials: () => request('settings/tmdb-credentials', { method: 'POST', body: JSON.stringify({ clear: true }) }),
  setAiCredentials: (payload) => request('settings/ai-credentials', { method: 'POST', body: JSON.stringify(payload) }),
  clearAiCredentials: () => request('settings/ai-credentials', { method: 'POST', body: JSON.stringify({ clear: true }) }),
  ...
  taskWash: (id) => request(`tasks/${id}/wash`),
  taskWashUnlock: (id, slug, confirmed = false) => request(`tasks/${id}/wash`, { method: 'POST', body: JSON.stringify({ slug, confirmed }) }),
  ...
  assistantMemory: () => request('assistant/memory'),
  assistantMemoryDelete: (indexes) => request('assistant/memory/delete', { method: 'POST', body: JSON.stringify({ indexes }) }),
  ...
  hdhiveSubscriptionUpgradeMode: (id, enabled) => request(`hdhive/subscriptions/${id}/upgrade-mode`, { method: 'POST', body: JSON.stringify({ enabled }) }),
  ...
  cmsVersionUpgrade: () => request('cms/version/upgrade', { method: 'POST' }),
