...
export const api = {
  ...
  qualityCleanupDryRun: (taskId) => request('quality/cleanup/dry-run', { method: 'POST', body: JSON.stringify({ task_id: taskId }) }),
  qualityCleanupRun: (taskId, paths) => request('quality/cleanup/run', { method: 'POST', body: JSON.stringify({ task_id: taskId, paths }) }),
